            ...
            <div id="rights" className="scroll-mt-24 mt-12 mb-12 p-6 bg-gray-50 rounded-xl border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p>You have the right to access, update, or delete your personal information at any time. You may also opt-out of receiving promotional communications. To exercise these rights or for any concerns related to your data, please contact us at @sikkimrisingstar@gmail.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 mb-12 p-6 bg-gray-50 rounded-xl border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p>We reserve the right to update or modify this Privacy Policy at any time. Changes will be posted on this page with an updated revision date. We encourage users to review this page periodically to stay informed about how we protect your data.</p>
                </div>
              </div>
            </div>
